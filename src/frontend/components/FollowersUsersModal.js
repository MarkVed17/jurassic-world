...
const FollowersUsersModal = ({ setFollowersUsersModal, followers }) => {
  const navigate = useNavigate();

  return (
    <div
      onClick={() => setFollowersUsersModal(false)}
    ...
    >
      ...
      >
        ...
        {followers.map(({ firstName, lastName, username, avatarURL }) => (
